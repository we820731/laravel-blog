...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection is_featured
     * @property Grid\Column|Collection featured_image
     ...
     * @method Grid\Column|Collection is_featured(string $label = null)
     * @method Grid\Column|Collection featured_image(string $label = null)
     ...
     * @property Show\Field|Collection is_featured
     * @property Show\Field|Collection featured_image
     ...
     * @method Show\Field|Collection is_featured(string $label = null)
     * @method Show\Field|Collection featured_image(string $label = null)
